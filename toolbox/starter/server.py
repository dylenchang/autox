...
from toolbox.common.config import configs, init_log, server_startup_config
...
def run() -> None:
    ...
    uvicorn.run(app="toolbox.starter.server:app", host=host, port=port, workers=workers)
