...
from toolbox.common.cache.redis_manager import RedisManager
...
async def get_cache_client() -> Cache:
    ...
    from toolbox.common.cache.redis_cache import RedisCache

    redis_client = await RedisManager.get_instance()
    if configs.enable_redis:
        return RedisCache(redis_client)
    else:
        from toolbox.common.cache.page_cache import PageCache
